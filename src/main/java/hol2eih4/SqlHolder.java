...
;
	...
	public static String departmentMotion= ""
			+" SELECT d1.icd_code, \n"
			+"        d1.icd_name, \n"
			+"        h.* \n"
			+" FROM \n"
			...
			;
	public static String departmentAdress = ""
			+" SELECT  \n"
			+" if(order_group<0,0,if(order_group=10000,2,1)) misto_raion_other \n"
			+" ,  if(order_group<0,'Всього місто',if(order_group=10000,'0','Всього райони'))  region_name  \n"
			...
			+" ORDER BY order_group , region_name \n"
			;
	public static String department = "SELECT * FROM department where department_id = :department_id";
	...
	public static String departmentIcd10Group = ""
			+" SELECT  \n"
			+" icd_code_group \n"
			+" , ds.icd_code \n"
