...
public class SqlHolder {
	...
	public static String bedDayMySql = ""
			...
			+"        bed_day  / department_bed  bed_occupancy, \n"
			+"         TREAT * 100 / bed_day treat_avg, \n"
			+"         (bed_day  / department_bed)/(TREAT * 100 / bed_day )  bed_turnover \n"
			+" FROM \n"
			+"   (SELECT d.*, \n"
			...
			+"                         WHERE d.department_id=db.department_id) department_bed, \n"
			+"                        (-- днів в місяці \n"
