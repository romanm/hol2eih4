...
;
	...
	public static String departmentIcd10 = ""
			...
			+" LEFT JOIN ( \n"
			+" SELECT referral_cnt  referral_has_cnt, referral_bed_day_sum referral_has_bed_day_sum, icd_id referral_has_icd_id  \n"
			+" FROM \n"
			+"   (SELECT referral.*, \n"
			...
			+" LEFT JOIN ( \n"
			+" SELECT referral_cnt  referral_self_cnt, referral_bed_day_sum referral_self_bed_day_sum, icd_id referral_self_icd_id  \n"
			+" FROM \n"
			+"   (SELECT referral.*, \n"
			+"           COUNT(referral) referral_cnt, \n"
			+"           SUM(referral_bed_day) referral_bed_day_sum \n"
			...
			+" LEFT JOIN ( \n"
			+" SELECT referral_cnt  referral_hol_cnt, referral_bed_day_sum referral_hol_bed_day_sum, icd_id referral_hol_icd_id  \n"
			+" FROM \n"
			+"   (SELECT referral.*, \n"
			+"           COUNT(referral) referral_cnt, \n"
			+"           SUM(referral_bed_day) referral_bed_day_sum \n"
