...
hol2eih3App.controller('F20t3500Ctrl', [ '$scope', '$http', '$filter', '$sce'
	...
	$scope.f20t3500Head = [
		...
		,{'key':'N', 'nrr':'1.0', 'name':'Усього операцій'}
		,{'key':'N','nrr':'2.0 ','name':'Операції на нервовій системі', 'groupById':1600}
		,{'key':'N','nrr':'2.1 ','name':'з них:  на головному мозку'}
		,{'key':'N','nrr':'2.2 ','name':'на периферичній нервовій системі'}
		,{'key':'N','nrr':'3.0 ','name':'Операції на ендокринній системі', 'groupById':100}
		,{'key':'N','nrr':'3.1 ','name':'з них:  на щитоподібній залозі'}
		,{'key':'N','nrr':'3.2 ','name':'паращитоподібних залозах'}
		,{'key':'N','nrr':'3.3 ','name':'наднирниках'}
		,{'key':'N','nrr':'4.0 ','name':'Операції на органах зору', 'groupById':200}
		,{'key':'N','nrr':'4.1 ','name':'з них з приводу:  глаукоми'}
		,{'key':'N','nrr':'4.2 ','name':'енукліації'}
		,{'key':'N','nrr':'4.3 ','name':'катаракти'}
		,{'key':'N','nrr':'5.0 ','name':'Операції на органах вуха, горла, носа', 'groupById':300}
		,{'key':'N','nrr':'5.1 ','name':'з них:  на вусі'}
		,{'key':'N','nrr':'5.2 ','name':'на мигдаликах та аденоїдах'}
		,{'key':'N','nrr':'6.0 ','name':'Операції на органах дихання', 'groupById':400}
		,{'key':'N','nrr':'6.1 ','name':'з них:  пульмоектомія'}
		,{'key':'N','nrr':'6.2 ','name':'резекція частини легені'}
		,{'key':'N','nrr':'6.3 ','name':'резекція сегмента легені'}
		,{'key':'N','nrr':'7.0 ','name':'Операції на серці', 'groupById':500}
		,{'key':'N','nrr':'7.1 ','name':'з них на відкритому серці'}
		,{'key':'N','nrr':'7.2 ','name':'аортокоронарне шунтування'}
		,{'key':'N','nrr':'7.3 ','name':'імплантація кардіостимулятора'}
		,{'key':'N','nrr':'8.0 ','name':'Операції на судинах', 'groupById':600}
		,{'key':'N','nrr':'8.1 ','name':'з них: на артеріях'}
		,{'key':'N','nrr':'8.2 ','name':'у тому числі на брахіоцефальних судинах'}
		,{'key':'N','nrr':'8.3 ','name':'на венах'}
		,{'key':'N','nrr':'8.4 ','name':'у тому числі венектомії при варикозному розширенні'}
		,{'key':'N','nrr':'8.5 ','name':'операції при післятромбофлеботичному синдромі'}
		,{'key':'N','nrr':'9.0 ','name':'Операції на органах травлення та черевної порожнини', 'groupById':700}
		,{'key':'N','nrr':'9.1 ','name':'з них: на стравоході'}
		,{'key':'N','nrr':'9.2 ','name':'на шлунку з приводу виразкової хвороби'}
		,{'key':'N','nrr':'9.3 ','name':'апендектомії при хронічному апендициті'}
		,{'key':'N','nrr':'9.4 ','name':'холецистектомії при хронічних холециститах'}
		,{'key':'N','nrr':'9.5 ','name':'у тому числі при жовчокам´яній хворобі'}
		,{'key':'N','nrr':'9.6 ','name':'операції на жовчних протоках'}
		,{'key':'N','nrr':'9.7 ','name':'операції на підшлунковій залозі'}
		,{'key':'N','nrr':'9.8 ','name':'у тому числі при  хронічному панкреатиті'}
		,{'key':'N','nrr':'9.9 ','name':'операції з приводу незащемленої грижі'}
		,{'key':'N','nrr':'9.10 ','name':'лапаротомії діагностичні'}
		...
		,{'key':'N','nrr':'11.1 ','name':'з них нефроектомії'}
		...
		,{'key':'N','nrr':'13.1 ','name':'з них: вишкрібання матки (крім штучного переривання вагітності)'}
		,{'key':'N','nrr':'13.2 ','name':'стерилізація жінок'}
		,{'key':'N','nrr':'14.0 ','name':'Акушерські операції', 'groupById':1200}
		,{'key':'N','nrr':'14.1 ','name':'з них: накладання щипців'}
		,{'key':'N','nrr':'14.2 ','name':'вакуум-екстракції'}
		,{'key':'N','nrr':'14.3 ','name':'кесарів розтин (крім малих піхвових)'}
		,{'key':'N','nrr':'14.4 ','name':'плодоруйнівні'}
		,{'key':'N','nrr':'14.5 ','name':'штучне переривання вагітності'}
		,{'key':'N','nrr':'14.6 ','name':'інші вишкрібання матки, які пов´язані з вагітністю (крім штучного переривання  вагітності)'}
		,{'key':'N','nrr':'14.7 ','name':'вакуум-аспірації'}
		,{'key':'N','nrr':'14.8 ','name':'вакуум-екскохлеації'}
		,{'key':'N','nrr':'15.0 ','name':'Операції на кістково-м´язовій системі', 'groupById':1300}
		,{'key':'N','nrr':'15.1 ','name':'з них на кістках і суглобах'}
		,{'key':'N','nrr':'15.2 ','name':'у тому числі ампутації кінцівок'}
		,{'key':'N','nrr':'15.3 ','name':'з них при судинних захворюваннях'}
		,{'key':'N','nrr':'15.4 ','name':'у тому числі при цукровому діабеті'}
		,{'key':'N','nrr':'16.0 ','name':'Операції на молочній залозі', 'groupById':1400}
		,{'key':'N','nrr':'16.1 ','name':'з них при злоякісних пухлинах'}
